...
/**
  ...
  */
#define DEBUGGER_ENABLED                     1  /* KoreroNet: keep SWD alive for bring-up */

/**
  * @brief Disable Low Power mode
  * @note  0: LowPowerMode enabled. MCU enters stop2 mode, 1: LowPowerMode disabled. MCU enters sleep mode only
  * @note  KoreroNet: 1 during bring-up. The CM0+ timebase is LPTIM1/LSE (keeps
  *        running in Stop2), so this can be set back to 0 later for battery life.
  */
