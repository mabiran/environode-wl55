...
void MX_GPIO_Init(void)
{
  ...
  /* EXTI interrupt init (Cortex-M0+ groups EXTI lines) */
  HAL_NVIC_SetPriority(EXTI1_0_IRQn, 0, 0);   /* BUT1 (line0) + BUT2 (line1) */
  HAL_NVIC_EnableIRQ(EXTI1_0_IRQn);

  HAL_NVIC_SetPriority(EXTI15_4_IRQn, 0, 0);  /* BUT3 (line6) */
