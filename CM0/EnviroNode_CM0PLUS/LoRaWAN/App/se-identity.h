 ...
 */
/* ===========================================================================
 *  KoreroNet TTN (AU915) OTAA credentials
 *  ---------------------------------------------------------------------------
 *  1) DevEUI below is left 00..00 -> derived automatically from the chip UID.
 *     Read it from the USB-serial boot log ("DevEui= ...") and register that
 *     DevEUI on TTN (or set an explicit one here to match your TTN device).
 *  2) JoinEUI 00..00 matches TTN's default AppEUI; enter the same in TTN.
 *  3) Paste your TTN device's AppKey into BOTH LORAWAN_APP_KEY and
 *     LORAWAN_NWK_KEY below (TTN uses LoRaWAN 1.0.x, where both equal AppKey).
 * =========================================================================== */
...
/*!
 * App/Join server IEEE EUI (big endian)  -- TTN default is all zeros
 */
 ...
 * !!! KoreroNet PLACEHOLDER — REPLACE with your TTN device AppKey (16 bytes) !!!
 */
#define LORAWAN_APP_KEY                                    00,11,22,33,44,55,66,77,88,99,AA,BB,CC,DD,EE,FF

/*!
 * Network root key
 * !!! KoreroNet PLACEHOLDER — for TTN (LoRaWAN 1.0.x) set this EQUAL to AppKey !!!
 */
#define LORAWAN_NWK_KEY                                    00,11,22,33,44,55,66,77,88,99,AA,BB,CC,DD,EE,FF
