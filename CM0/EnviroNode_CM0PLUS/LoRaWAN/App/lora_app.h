...
/* KoreroNet: New Zealand / TTN AU -> AU915 (sub-band 2 / FSB2 enforced in lora_app.c). */
 ...
 * KoreroNet: 1 hour. (First HELLO is sent right after the OTAA join; then hourly.)
 * Lower this temporarily, e.g. 60000 (1 min), while testing the join.
 */
